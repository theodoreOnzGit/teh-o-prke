use tuas_boussinesq_solver::array_control_vol_and_fluid_component_collections::fluid_component_collection::{fluid_component_collection::FluidComponentCollection, fluid_component_super_collection::FluidComponentSuperCollection, super_collection_series_and_parallel_functions::FluidComponentSuperCollectionParallelAssociatedFunctions};
...
pub fn calculate_pressure_change_from_mass_flowrate(
    ...
    if user_requested_mass_flowrate.value.abs() < 1e-9_f64 {
        ...
        return <FluidComponentSuperCollection as FluidComponentSuperCollectionParallelAssociatedFunctions>::
